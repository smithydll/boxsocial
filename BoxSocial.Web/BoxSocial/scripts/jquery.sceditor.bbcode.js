...
/***/ function(module, exports, __webpack_require__) {
	...
	// TODO: move these styles into the CSS file
			...
			youtube:
				'<iframe class="youtube-player" width="560" height="340" ' +
	...
	var bbcodes = {
		...
		code: {
		    ...
		    format: function (element, content) {
		        ...
		        var captionEl = $el.children('strong');
		        var caption = '';
		        if (!(typeof captionEl === 'undefined') && captionEl.length > 0) {
		            caption = ' caption="' + captionEl.text() + '"';
		        }
		        var colour = code[0].style.color;
		        colour = (!(typeof colour === 'undefined') && colour != '') ? ' color=' + $.sceditor.plugins.bbcode.normaliseColour(colour) : '';
		...
		align: {
		    ...
		    format: function (element, content) {
		        var $el = $(element);
		        return '[align=' + $el.css('text-align') + ']' + content + '[/align]';
		    },
		    html: function (token, attrs, content) {
