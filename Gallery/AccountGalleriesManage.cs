        ...
        void AccountGalleriesManage_Show(object sender, EventArgs e)
        {
            ...
            if (parentGalleryId > 0)
            {
                try
                {
                    ...
                    template.Parse("U_PERMISSIONS", core.Uri.AppendAbsoluteSid(string.Format("/api/acl?id={0}&type={1}", pg.Id, ItemType.GetTypeId(typeof(Gallery))), true));
            ...
            else
            {
                ...
                template.Parse("U_PERMISSIONS", core.Uri.AppendAbsoluteSid(string.Format("/api/acl?id={0}&type={1}", pg.Settings.Id, ItemType.GetTypeId(typeof(GallerySettings))), true));
            }
