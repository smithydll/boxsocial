...
namespace BoxSocial.Groups
{
    public class Default
    {
        ...
        public static void ShowCategory(object sender, ShowPageEventArgs e)
        {
            ...
            List<UserGroup> groups = UserGroup.GetUserGroups(e.Core, category);
            ...
            e.Core.Display.ParsePagination(UserGroup.BuildCategoryUri(e.Core, category), e.Page.page, (int)Math.Ceiling(category.Groups / 10.0));
