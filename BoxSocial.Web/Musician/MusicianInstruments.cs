...
{
    [DataTable("music_member_instruments")]
    public class MusicianInstruments : Item
    {
        [DataField("instrument_id", DataFieldKeys.Primary, "P_TERNARY")]
        private long instrumentId;
        [DataField("musician_id", DataFieldKeys.Primary, "P_TERNARY")]
