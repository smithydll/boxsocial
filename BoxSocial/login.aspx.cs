        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Form["submit"] != null)
            {
                ...
                string password = Member.HashPassword(Request.Form["password"]);
                 ...
                 DataTable userTable = db.SelectQuery(string.Format("SELECT uk.user_name, uk.user_id FROM user_keys uk INNER JOIN user_info ui ON uk.user_id = ui.user_id WHERE uk.user_name = '{0}' AND ui.user_password = '{1}'",
                    userName, password));
