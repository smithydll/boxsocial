...
<![%bibliolist.element;[
<!--doc:A wrapper for a list of bibliography entries.
While bibliographys are usually limited to component or section boundaries, appearing at the end of a book or chapter, for instance, bibliolists can appear anywhere that the other list types are allowed. Using a bibliolist in running text, instead of a variablelist, for example, maintains the semantic distinction of a Bibliography.
...
<![%package.element;[
<!--doc:A software or application package..
The package element identifies a package of some sort. The precise kind of package is context dependent. It might be used, for example, to identify a Java package or a operating system distribution package.-->
...
<![%biblioref.element;[
<!--doc:References by bibliography entries..
