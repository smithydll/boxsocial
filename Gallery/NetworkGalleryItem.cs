...
namespace BoxSocial.Applications.Gallery
{
    public class NetworkGalleryItem : GalleryItem
    {
        ...
        public static GalleryItem Create(TPage page, Network owner, Gallery parent, string title, ref string slug, string fileName, string storageName, string contentType, ulong bytes, string description, ushort permissions, byte license)
        {
