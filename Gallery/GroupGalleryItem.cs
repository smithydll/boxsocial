...
namespace BoxSocial.Applications.Gallery
{
    public class GroupGalleryItem : GalleryItem
    {
        ...
        public static GalleryItem Create(TPage page, UserGroup owner, Gallery parent, string title, ref string slug, string fileName, string storageName, string contentType, ulong bytes, string description, ushort permissions, byte license)
        {
            long itemId = GalleryItem.create(page, (Primitive)owner, parent, title, ref slug, fileName, storageName, contentType, bytes, description, permissions, license);
