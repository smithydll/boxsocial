        ...
        void AccountForumManage_Show(object sender, EventArgs e)
        {
            ...
            if (thisForum != null)
            {
                ...
                foreach (Forum forum in forums)
                {
                    ...
                    forumVariableCollection.Parse("U_EDIT_PERMISSION", core.Uri.AppendAbsoluteSid(string.Format("/acl.aspx?id={0}&type={1}", forum.Id, ItemType.GetTypeId(typeof(Forum))), true));
                }
            }
